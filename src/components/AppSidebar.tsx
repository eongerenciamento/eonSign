  ...
  return <Sidebar className={`${collapsed ? "w-16" : "w-64"} bg-gradient-to-b from-[#273d60] to-[#001a4d]`} collapsible="icon">
      ...
      <div className={`${collapsed ? "px-3 py-4" : "p-6"} flex flex-col items-center bg-[#273d60]`}>
        ...
        {!collapsed && <div className="mt-6 flex justify-center w-full">
            <img alt="Éon Sign" className="h-13 w-auto object-contain" src="/lovable-uploads/cf697ca1-b048-4c88-8e66-1659b20e2d9e.png" />
          </div>}
      </div>
      ...
      <div className="p-4 mt-auto bg-[#273d60]">
        {!collapsed && <button onClick={() => window.open('https://eongerenciamento.com.br', '_blank')} className="w-full mb-3 px-4 py-2 rounded-lg bg-gradient-to-r from-[#273d60] to-[#001f3f] text-white hover:opacity-90 transition-opacity text-xs bg-[#283e61]/75 font-light">
