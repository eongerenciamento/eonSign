...
export function MobileNav() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#273d60] dark:bg-[hsl(var(--sidebar-background))] flex items-center justify-center h-14 md:hidden border-none px-4 shadow-lg dark:shadow-none">
