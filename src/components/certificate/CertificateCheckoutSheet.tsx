...
interface CertificateCheckoutSheetProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function CertificateCheckoutSheet({
  open,
  onOpenChange
}: CertificateCheckoutSheetProps) {
        ...
        <div className="flex-1 overflow-y-auto bg-background">
          ...
          <div className="space-y-4 pt-6">
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="PF" id="pf-sheet" />
                  <Label htmlFor="pf-sheet" className="cursor-pointer">
                    Pessoa Física
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="PJ" id="pj-sheet" />
                  <Label htmlFor="pj-sheet" className="cursor-pointer">
                    Pessoa Jurídica
                  </Label>
                </div>
              </RadioGroup>
            ...
            {type === "PJ" && (
              <>
                <div className="space-y-2">
                  <Label htmlFor="cnpj-sheet">CNPJ</Label>
                  <Input
                    id="cnpj-sheet"
                ...
                <div className="space-y-2">
                  <Label htmlFor="responsibleName-sheet">Nome do Responsável</Label>
                  <Input
                    id="responsibleName-sheet"
            ...
            {/* Common Fields */}
            <div className="space-y-2">
              <Label htmlFor="name-sheet">Nome Completo</Label>
              <Input
                id="name-sheet"
            ...
            <div className="space-y-2">
              <Label htmlFor="cpf-sheet">CPF</Label>
              <Input
                id="cpf-sheet"
            ...
            <div className="space-y-2">
              <Label htmlFor="birthDate-sheet">Data de Nascimento</Label>
              <Input
                id="birthDate-sheet"
            ...
            <div className="space-y-2">
              <Label htmlFor="email-sheet">E-mail</Label>
              <Input
                id="email-sheet"
                type="email"
            ...
            <div className="space-y-2">
              <Label htmlFor="phone-sheet">Telefone</Label>
              <Input
                id="phone-sheet"
