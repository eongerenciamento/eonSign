  ...
  return <Layout>
      <div className="p-8 pb-20 space-y-6 w-full overflow-hidden">
        <div className="flex items-center justify-between">
          ...
          <Button onClick={() => window.open('/certificados/comprar', '_blank')} className="md:hidden bg-[#283d60] text-white font-light hover:bg-[#283d60]/90 text-xs px-3 py-1 h-auto">
