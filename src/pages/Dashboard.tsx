  ...
  return <Layout>
      <div className="p-8 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button onClick={() => navigate("/novo-documento")} className="bg-secondary hover:bg-secondary/80 shadow-lg rounded-full w-12 h-12 p-0 md:w-auto md:h-auto md:px-4 md:py-2 md:rounded-full font-normal">
