...
const signupSchema = z.object({
  organizationName: z.string().trim().min(1, { message: "Nome da organização é obrigatório" }),
  cnpj: z.string().trim().min(14, { message: "CNPJ inválido" }),
  adminName: z.string().trim().min(1, { message: "Nome do membro é obrigatório" }),
  adminCpf: z.string().trim().min(11, { message: "CPF inválido" }),
  adminPhone: z.string().trim().min(10, { message: "Telefone inválido" }),
  email: z.string().trim().email({ message: "E-mail inválido" }),
  password: z.string().min(6, { message: "A senha deve ter no mínimo 6 caracteres" }),
...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#273d60] to-[#001f3f] px-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <>
                <div className="space-y-2 animate-fade-in" style={{ animationDelay: '0.5s' }}>
                  ...
                  <Input 
                    ...
                    required 
                    disabled={isLoading} 
                    className="bg-[hsl(221,30%,35%)] border border-white/20 text-white [&:-webkit-autofill]:!bg-[hsl(221,30%,35%)] [&:-webkit-autofill]:text-white [&:-webkit-autofill]:[-webkit-text-fill-color:white] [&:-webkit-autofill]:[-webkit-box-shadow:0_0_0_1000px_hsl(221,30%,35%)_inset]" 
                  />
                </div>
                ...
                <div className="space-y-2 animate-fade-in" style={{ animationDelay: '0.6s' }}>
                  ...
                  <div className="relative">
                    <Input 
                      ...
                      required 
                      disabled={isLoading} 
                      className="bg-[hsl(221,30%,35%)] border border-white/20 text-white pr-10 [&:-webkit-autofill]:!bg-[hsl(221,30%,35%)] [&:-webkit-autofill]:text-white [&:-webkit-autofill]:[-webkit-text-fill-color:white] [&:-webkit-autofill]:[-webkit-box-shadow:0_0_0_1000px_hsl(221,30%,35%)_inset]" 
                    />
                    <button 
                      type="button" 
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input 
                        ...
                        required 
                        disabled={isLoading}
                        className="bg-[hsl(221,30%,35%)] border border-white/20 text-white pr-10" 
                      />
                      <button 
                        type="button" 
                        onClick={() => setShowPassword(!showPassword)} 
            ...
            <div className="space-y-3 animate-fade-in" style={{ animationDelay: '0.7s' }}>
              <Button 
                type="submit" 
                variant="ghost" 
                className="w-full text-white hover:bg-transparent hover:text-white/90 transition-transform hover:scale-105" 
                disabled={isLoading}
              >
