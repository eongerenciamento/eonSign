...
export default function Auth() {
  ...
  const getHeaderText = () => {
    switch (mode) {
      case 'register':
        return { title: "Criar Conta", subtitle: "Comece grátis!" };
      case 'success':
        return { title: "", subtitle: "" };
      default:
        return { title: "Login", subtitle: "Bem-vindo de volta!" };
    }
  };
      ...
      default:
        return (
          <LoginForm
            ...
            onInstallClick={() => navigate("/install")}
          />
        );
    }
  };
  ...
  return (
    <div className="light" style={{ colorScheme: 'light' }}>
      ...
      >
        <div
          className="relative flex-shrink-0 pt-[env(safe-area-inset-top)] px-6 pb-36"
        ...
        <div
          className="flex-1 rounded-t-3xl -mt-4 px-6 py-5 relative z-30 flex flex-col"
          style={{ backgroundColor: '#ffffff' }}
        >
          {mode !== 'success' && (
            <div className="text-center mb-6">
              <h1 style={{ color: '#111827' }} className="text-2xl font-bold">
                {title}
              </h1>
      ...
      {/* Desktop Layout */}
      <div
        className="hidden md:flex min-h-screen p-6"
        style={{ backgroundColor: '#ffffff' }}
      >
        <div
          className="relative w-[40%] flex flex-col items-center justify-center rounded-3xl overflow-hidden"
          style={{ background: "linear-gradient(to bottom, #273D60, #0a1525)" }}
        >
          <RadialGlow />
        ...
        <div
          className="w-[60%] flex flex-col items-center justify-center p-8 rounded-r-3xl"
          style={{ backgroundColor: '#ffffff' }}
        >
          <div className="w-full max-w-md">
            {mode !== 'success' && (
              <div className="text-center mb-8">
                <h1 style={{ color: '#4b5563' }} className="text-2xl font-bold">
                  {title}
                </h1>
                {subtitle && (
                  <p className="mt-1" style={{ color: '#6b7280' }}>
