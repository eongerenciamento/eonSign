...
serve(async (req) => {
  ...
  try {
    ...
    console.log("[ADMIN-COUPONS] Fetching coupons from Stripe...");
    ...
    console.log("[ADMIN-COUPONS] Found", coupons.data.length, "coupons");
    ...
    console.error("[ADMIN-COUPONS] Error:", errorMessage);
